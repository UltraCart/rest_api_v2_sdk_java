...
**processingFee** | [**BigDecimal**](BigDecimal.md) | Optional additional fee to charge if PayPal is used.  It is rare for this to be used. |  [optional]
**processingPercentage** | [**BigDecimal**](BigDecimal.md) | The processing percentage charged by PayPal |  [optional]
