...
|**contextAffiliateOid** | **Integer** | Affiliate oid for the rendering context. |  [optional] |
|**contextBlogPostOid** | **Integer** | Blog post oid for the rendering context. |  [optional] |
