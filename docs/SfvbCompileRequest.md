...
|**storefrontOid** | **Integer** | Optional storefront oid.  Required when theme_oid is supplied. |  [optional] |
|**themeOid** | **Integer** | Optional theme oid.  Supplies the theme&#39;s inherit groups configuration so compilation matches what the theme would produce.  Omit to compile without inheritance. |  [optional] |
