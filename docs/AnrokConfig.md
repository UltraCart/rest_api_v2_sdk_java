...
|**estimateOnly** | **Boolean** | True if this Anrok configuration is to estimate taxes only and not report placed orders to Anrok |  [optional] |
|**lastTestDts** | **String** | Date/time of the connection test to Anrok |  [optional] |
|**shippingProductId** | **String** | Anrok Product ID used to classify shipping/handling charges; must be created in Anrok and mapped to the Shipping cost tax category |  [optional] |
