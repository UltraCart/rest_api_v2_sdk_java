...
<a name="getOrderEmails"></a>
# **getOrderEmails**
> OrderEmailsResponse getOrderEmails(orderId)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **orderId** | **String**| The order id to retrieve email delivery information for. | |
...
# **getOrderUpsellCart**
> OrderResponse getOrderUpsellCart(orderId, upsellCartRequest, expand)
...
> OrderResponse heldOrderAddItemsAndRelease(orderId, addItemsAndReleaseRequest, expand)
