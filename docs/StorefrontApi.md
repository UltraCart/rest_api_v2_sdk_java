...
<a name="getEmailCommseqEditorValues"></a>
# **getEmailCommseqEditorValues**
> EmailEditorValuesResponse getEmailCommseqEditorValues(storefrontOid)
...
Integer storefrontOid = 56; // Integer | 
try {
    EmailEditorValuesResponse result = apiInstance.getEmailCommseqEditorValues(storefrontOid);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling StorefrontApi#getEmailCommseqEditorValues");
    e.printStackTrace();
}
```
...
> insertUpdatePageContentAttribute(pageAttribute, storefrontOid, pageOid)
