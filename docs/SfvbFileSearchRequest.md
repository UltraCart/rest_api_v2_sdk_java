...
|**maxResults** | **Integer** | Maximum results to return.  Clamped to the server maximum. |  [optional] |
...
|**sizeMax** | **Integer** | Maximum size in bytes. |  [optional] |
|**sizeMin** | **Integer** | Minimum size in bytes. |  [optional] |
