...
See https://mvnrepository.com/artifact/com.ultracart/rest-sdk
```xml
<!-- https://mvnrepository.com/artifact/com.ultracart/rest-sdk -->
<dependency>
    <groupId>com.ultracart</groupId>
    <artifactId>rest-sdk</artifactId>
    <version>4.1.172</version>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.ultracart:rest-sdk:4.1.172"
  }
```
...
## Documentation for Models
 ...
 - [BulkJobRequest](docs/BulkJobRequest.md)
 - [BulkJobResponse](docs/BulkJobResponse.md)
 - [BulkJobsResponse](docs/BulkJobsResponse.md)
 - [BulkRecord](docs/BulkRecord.md)
 - [BulkRecordsResponse](docs/BulkRecordsResponse.md)
 - [BulkUploadUrlResponse](docs/BulkUploadUrlResponse.md)
 - [Cart](docs/Cart.md)
 ...
 - [ConversationAgentCallEvent](docs/ConversationAgentCallEvent.md)
 - [ConversationAgentChatEvent](docs/ConversationAgentChatEvent.md)
 ...
 - [ConversationAgentStatusConfig](docs/ConversationAgentStatusConfig.md)
 - [ConversationAgentStatusConfigResponse](docs/ConversationAgentStatusConfigResponse.md)
 - [ConversationAgentStatusConfigsResponse](docs/ConversationAgentStatusConfigsResponse.md)
 - [ConversationAgentStatusEvent](docs/ConversationAgentStatusEvent.md)
 - [ConversationAgentStatusHeatmapRequest](docs/ConversationAgentStatusHeatmapRequest.md)
 - [ConversationAgentStatusHeatmapResponse](docs/ConversationAgentStatusHeatmapResponse.md)
 - [ConversationAgentStatusHistorySearchRequest](docs/ConversationAgentStatusHistorySearchRequest.md)
 - [ConversationAgentStatusHistorySearchResponse](docs/ConversationAgentStatusHistorySearchResponse.md)
 - [ConversationAgentStatusRollup](docs/ConversationAgentStatusRollup.md)
 - [ConversationAgentStatusRollupSearchRequest](docs/ConversationAgentStatusRollupSearchRequest.md)
 ...
 - [ConversationEmbedPbxAuthResponse](docs/ConversationEmbedPbxAuthResponse.md)
 ...
 - [ConversationPbxCall](docs/ConversationPbxCall.md)
 ...
 - [ConversationPbxCallFinancial](docs/ConversationPbxCallFinancial.md)
 - [ConversationPbxCallHold](docs/ConversationPbxCallHold.md)
 - [ConversationPbxCallQueue](docs/ConversationPbxCallQueue.md)
 - [ConversationPbxCallRecording](docs/ConversationPbxCallRecording.md)
 - [ConversationPbxCallResponse](docs/ConversationPbxCallResponse.md)
 - [ConversationPbxCallRouting](docs/ConversationPbxCallRouting.md)
 - [ConversationPbxCallSearchRequest](docs/ConversationPbxCallSearchRequest.md)
 - [ConversationPbxCallSearchResponse](docs/ConversationPbxCallSearchResponse.md)
 - [ConversationPbxCallTimeline](docs/ConversationPbxCallTimeline.md)
 ...
 - [ConversationPbxCosAuditLog](docs/ConversationPbxCosAuditLog.md)
 - [ConversationPbxCosAuditLogsResponse](docs/ConversationPbxCosAuditLogsResponse.md)
 ...
 - [ConversationPbxDefaultTimezoneResponse](docs/ConversationPbxDefaultTimezoneResponse.md)
 - [ConversationPbxDefaultTimezoneUpdateRequest](docs/ConversationPbxDefaultTimezoneUpdateRequest.md)
 ...
 - [ConversationPbxPayConnector](docs/ConversationPbxPayConnector.md)
 - [ConversationPbxPayConnectorsResponse](docs/ConversationPbxPayConnectorsResponse.md)
 ...
 - [ConversationVirtualAgentCapabilityCustomCollection](docs/ConversationVirtualAgentCapabilityCustomCollection.md)
 ...
 - [CouponAmountOffItemsAndFreeShipping](docs/CouponAmountOffItemsAndFreeShipping.md)
 ...
 - [CustomerEmailSuppressionRequest](docs/CustomerEmailSuppressionRequest.md)
 - [CustomerEmailSuppressionResponse](docs/CustomerEmailSuppressionResponse.md)
 - [CustomerEmailSuppressionResult](docs/CustomerEmailSuppressionResult.md)
 ...
 - [EmailSuppressionSurfaces](docs/EmailSuppressionSurfaces.md)
 ...
 - [FraudRuleResponse](docs/FraudRuleResponse.md)
 - [FraudRuleRotatingTransactionGatewayFilter](docs/FraudRuleRotatingTransactionGatewayFilter.md)
 - [FraudRuleSearchRequest](docs/FraudRuleSearchRequest.md)
 - [FraudRuleStorefrontFilter](docs/FraudRuleStorefrontFilter.md)
 - [FraudRulesResponse](docs/FraudRulesResponse.md)
 ...
 - [SfvbContainerRevertRequest](docs/SfvbContainerRevertRequest.md)
 - [SfvbContainerVersion](docs/SfvbContainerVersion.md)
 - [SfvbContainerVersionsResponse](docs/SfvbContainerVersionsResponse.md)
 - [SfvbContainerWriteRequest](docs/SfvbContainerWriteRequest.md)
 - [SfvbElement](docs/SfvbElement.md)
 ...
 - [SfvbUpsellItemLogic](docs/SfvbUpsellItemLogic.md)
 - [SfvbUpsellItemLogicItem](docs/SfvbUpsellItemLogicItem.md)
 - [SfvbUpsellOffer](docs/SfvbUpsellOffer.md)
 - [SfvbUpsellOffersResponse](docs/SfvbUpsellOffersResponse.md)
 - [SfvbUpsellPath](docs/SfvbUpsellPath.md)
 - [SfvbUpsellPathDuplicateRequest](docs/SfvbUpsellPathDuplicateRequest.md)
 - [SfvbUpsellPathMoveRequest](docs/SfvbUpsellPathMoveRequest.md)
 - [SfvbUpsellPathsResponse](docs/SfvbUpsellPathsResponse.md)
 - [SfvbUpsellStats](docs/SfvbUpsellStats.md)
 - [SfvbUpsellStep](docs/SfvbUpsellStep.md)
 - [SfvbUpsellStepOffer](docs/SfvbUpsellStepOffer.md)
 - [SfvbUpsellTowerData](docs/SfvbUpsellTowerData.md)
 - [SfvbUpsellVariation](docs/SfvbUpsellVariation.md)
 - [SfvbValidateRequest](docs/SfvbValidateRequest.md)
 - [SfvbValidationResponse](docs/SfvbValidationResponse.md)
 - [SfvbVelocityValidateRequest](docs/SfvbVelocityValidateRequest.md)
 - [SfvbVersionResponse](docs/SfvbVersionResponse.md)
 - [SfvbWhoamiResponse](docs/SfvbWhoamiResponse.md)
 - [SfvbWidgetIdsResponse](docs/SfvbWidgetIdsResponse.md)
 ...
 - [ZohoDeskTicketSummary](docs/ZohoDeskTicketSummary.md)
