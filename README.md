...
- API version: 2.0.0
  - Build date: 2023-01-10T11:25:46.475-05:00[America/Indianapolis]
...
```groovy
  ...
  dependencies {
     implementation "com.ultracart:rest-sdk:4.0.109-RC"
  }
```
...
* `target/rest-sdk-4.0.109-RC.jar`
* `target/lib/*.jar`
