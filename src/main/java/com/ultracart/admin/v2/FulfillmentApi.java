...
public class FulfillmentApi {
  ...
  public FulfillmentApi(String apiKey, boolean verifySsl, boolean debugging){
    ...
    public OrdersResponse generatePackingSlip(String distributionCenterCode, String orderId) throws ApiException {
        ApiResponse<OrdersResponse> resp = generatePackingSlipWithHttpInfo(distributionCenterCode, orderId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call generatePackingSlipAsync(String distributionCenterCode, String orderId, final ApiCallback<OrdersResponse> callback) throws ApiException {
