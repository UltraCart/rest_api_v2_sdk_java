...
import com.ultracart.admin.v2.models.WebhookEventCategoriesResponse;
...
public class WebhookApi {
  ...
  public WebhookApi(String apiKey, boolean verifySsl, boolean debugging){
    ...
    /**
     * Build call for getWebhookEventCategories
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getWebhookEventCategoriesCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/webhook/webhook_event_categories";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWebhookEventCategoriesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getWebhookEventCategoriesCall(_callback);
        return localVarCall;
     ...
     */
    public WebhookEventCategoriesResponse getWebhookEventCategories() throws ApiException {
        ApiResponse<WebhookEventCategoriesResponse> localVarResp = getWebhookEventCategoriesWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Retrieve webhook event categories
     * Retrieves the available webhook event categories and events with backend-owned metadata (OIDs, names, descriptions, available expansions, flags) independent of whether any webhooks are saved.  Used by the New Webhook editor so a merchant with zero webhooks can still see the catalog. 
     * @return ApiResponse&lt;WebhookEventCategoriesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WebhookEventCategoriesResponse> getWebhookEventCategoriesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getWebhookEventCategoriesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<WebhookEventCategoriesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve webhook event categories (asynchronously)
     * Retrieves the available webhook event categories and events with backend-owned metadata (OIDs, names, descriptions, available expansions, flags) independent of whether any webhooks are saved.  Used by the New Webhook editor so a merchant with zero webhooks can still see the catalog. 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getWebhookEventCategoriesAsync(final ApiCallback<WebhookEventCategoriesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWebhookEventCategoriesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<WebhookEventCategoriesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param beginDate Filter to deliveries on or after this date/time (optional)
     * @param endDate Filter to deliveries on or before this date/time (optional)
     * @param status Filter by HTTP status code (optional)
     * @param success Filter by success (true) or failure (false) (optional)
     * @param event Filter by an event name contained in the delivery (optional)
     * @param orderId Filter by an order id contained in the delivery (optional)
     * @param request Filter by text contained in the request payload (optional)
     * @param duration Filter to deliveries that took at least this many milliseconds (optional)
     ...
     */
    public okhttp3.Call getWebhookLogSummariesCall(Integer webhookOid, String requestId, String beginDate, String endDate, String status, Boolean success, String event, String orderId, String request, Integer duration, Integer limit, Integer offset, String since, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWebhookLogSummariesValidateBeforeCall(Integer webhookOid, String requestId, String beginDate, String endDate, String status, Boolean success, String event, String orderId, String request, Integer duration, Integer limit, Integer offset, String since, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWebhookLogSummariesCall(webhookOid, requestId, beginDate, endDate, status, success, event, orderId, request, duration, limit, offset, since, _callback);
        return localVarCall;
     ...
     */
    public WebhookLogSummariesResponse getWebhookLogSummaries(Integer webhookOid, String requestId, String beginDate, String endDate, String status, Boolean success, String event, String orderId, String request, Integer duration, Integer limit, Integer offset, String since) throws ApiException {
        ApiResponse<WebhookLogSummariesResponse> localVarResp = getWebhookLogSummariesWithHttpInfo(webhookOid, requestId, beginDate, endDate, status, success, event, orderId, request, duration, limit, offset, since);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WebhookLogSummariesResponse> getWebhookLogSummariesWithHttpInfo(Integer webhookOid, String requestId, String beginDate, String endDate, String status, Boolean success, String event, String orderId, String request, Integer duration, Integer limit, Integer offset, String since) throws ApiException {
        okhttp3.Call localVarCall = getWebhookLogSummariesValidateBeforeCall(webhookOid, requestId, beginDate, endDate, status, success, event, orderId, request, duration, limit, offset, since, null);
    ...
    public okhttp3.Call getWebhookLogSummariesAsync(Integer webhookOid, String requestId, String beginDate, String endDate, String status, Boolean success, String event, String orderId, String request, Integer duration, Integer limit, Integer offset, String since, final ApiCallback<WebhookLogSummariesResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWebhookLogSummariesValidateBeforeCall(webhookOid, requestId, beginDate, endDate, status, success, event, orderId, request, duration, limit, offset, since, _callback);
        Type localVarReturnType = new TypeToken<WebhookLogSummariesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
