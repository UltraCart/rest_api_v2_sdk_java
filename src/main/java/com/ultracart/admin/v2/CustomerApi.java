...
import com.ultracart.admin.v2.models.AdjustLoyaltyPointsRequest;
import com.ultracart.admin.v2.models.AdjustLoyaltyPointsResponse;
...
import com.ultracart.admin.v2.models.CustomerEmailSuppressionRequest;
import com.ultracart.admin.v2.models.CustomerEmailSuppressionResponse;
import com.ultracart.admin.v2.models.CustomerLoyaltyResponse;
...
import com.ultracart.admin.v2.models.QuickBooksOnlineCustomersResponse;
...
public class CustomerApi {
  ...
  public CustomerApi(String apiKey, boolean verifySsl, boolean debugging){
     ...
     * @param customerProfileOid The customer profile oid (required)
     * @param adjustLoyaltyPointsRequest adjustLoyaltyPointsRequest (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call adjustLoyaltyPointsCall(Integer customerProfileOid, AdjustLoyaltyPointsRequest adjustLoyaltyPointsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/customer/customers/{customer_profile_oid}/adjust_loyalty_points"
            .replaceAll("\\{" + "customer_profile_oid" + "\\}", localVarApiClient.escapeString(customerProfileOid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adjustLoyaltyPointsValidateBeforeCall(Integer customerProfileOid, AdjustLoyaltyPointsRequest adjustLoyaltyPointsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'customerProfileOid' is set
        if (customerProfileOid == null) {
            throw new ApiException("Missing the required parameter 'customerProfileOid' when calling adjustLoyaltyPoints(Async)");
        }
        ...
        okhttp3.Call localVarCall = adjustLoyaltyPointsCall(customerProfileOid, adjustLoyaltyPointsRequest, _callback);
        return localVarCall;
     ...
     */
    public AdjustLoyaltyPointsResponse adjustLoyaltyPoints(Integer customerProfileOid, AdjustLoyaltyPointsRequest adjustLoyaltyPointsRequest) throws ApiException {
        ApiResponse<AdjustLoyaltyPointsResponse> localVarResp = adjustLoyaltyPointsWithHttpInfo(customerProfileOid, adjustLoyaltyPointsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AdjustLoyaltyPointsResponse> adjustLoyaltyPointsWithHttpInfo(Integer customerProfileOid, AdjustLoyaltyPointsRequest adjustLoyaltyPointsRequest) throws ApiException {
        okhttp3.Call localVarCall = adjustLoyaltyPointsValidateBeforeCall(customerProfileOid, adjustLoyaltyPointsRequest, null);
        Type localVarReturnType = new TypeToken<AdjustLoyaltyPointsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger. (asynchronously)
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.  The loyalty ledger is append only.  Records are never updated or deleted, so a correction is made by posting a second adjustment with the opposite sign. 
     * @param customerProfileOid The customer profile oid (required)
     * @param adjustLoyaltyPointsRequest adjustLoyaltyPointsRequest (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call adjustLoyaltyPointsAsync(Integer customerProfileOid, AdjustLoyaltyPointsRequest adjustLoyaltyPointsRequest, final ApiCallback<AdjustLoyaltyPointsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = adjustLoyaltyPointsValidateBeforeCall(customerProfileOid, adjustLoyaltyPointsRequest, _callback);
        Type localVarReturnType = new TypeToken<AdjustLoyaltyPointsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call deleteWishListItemCall(Integer customerProfileOid, Integer customerWishlistItemOid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        String localVarPath = "/customer/customers/{customer_profile_oid}/wishlist/{customer_wishlist_item_oid}"
            .replaceAll("\\{" + "customer_profile_oid" + "\\}", localVarApiClient.escapeString(customerProfileOid.toString()))
            .replaceAll("\\{" + "customer_wishlist_item_oid" + "\\}", localVarApiClient.escapeString(customerWishlistItemOid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteWishListItemValidateBeforeCall(Integer customerProfileOid, Integer customerWishlistItemOid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteWishListItemCall(customerProfileOid, customerWishlistItemOid, _callback);
        return localVarCall;
    ...
    /**
     * Build call for getCustomerLoyalty
     * @param customerProfileOid The customer oid to retrieve. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getCustomerLoyaltyCall(Integer customerProfileOid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/customer/customers/{customer_profile_oid}/loyalty"
            .replaceAll("\\{" + "customer_profile_oid" + "\\}", localVarApiClient.escapeString(customerProfileOid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomerLoyaltyValidateBeforeCall(Integer customerProfileOid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'customerProfileOid' is set
        if (customerProfileOid == null) {
            throw new ApiException("Missing the required parameter 'customerProfileOid' when calling getCustomerLoyalty(Async)");
        }
        

        okhttp3.Call localVarCall = getCustomerLoyaltyCall(customerProfileOid, _callback);
        return localVarCall;
     ...
     */
    public CustomerLoyaltyResponse getCustomerLoyalty(Integer customerProfileOid) throws ApiException {
        ApiResponse<CustomerLoyaltyResponse> localVarResp = getCustomerLoyaltyWithHttpInfo(customerProfileOid);
        return localVarResp.getData();
    }
     ...
     * Retrieve the loyalty points, ledger and redemptions for a customer.  This is a convenience method that returns the same information as expanding loyalty on the customer object, without having to retrieve the entire customer. 
     * @param customerProfileOid The customer oid to retrieve. (required)
     * @return ApiResponse&lt;CustomerLoyaltyResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomerLoyaltyResponse> getCustomerLoyaltyWithHttpInfo(Integer customerProfileOid) throws ApiException {
        okhttp3.Call localVarCall = getCustomerLoyaltyValidateBeforeCall(customerProfileOid, null);
        Type localVarReturnType = new TypeToken<CustomerLoyaltyResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the loyalty points, ledger and redemptions for a customer (asynchronously)
     * Retrieve the loyalty points, ledger and redemptions for a customer.  This is a convenience method that returns the same information as expanding loyalty on the customer object, without having to retrieve the entire customer. 
     * @param customerProfileOid The customer oid to retrieve. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getCustomerLoyaltyAsync(Integer customerProfileOid, final ApiCallback<CustomerLoyaltyResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomerLoyaltyValidateBeforeCall(customerProfileOid, _callback);
        Type localVarReturnType = new TypeToken<CustomerLoyaltyResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getCustomerWishListCall(Integer customerProfileOid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomerWishListValidateBeforeCall(Integer customerProfileOid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomerWishListCall(customerProfileOid, _callback);
        return localVarCall;
    ...
    public CustomerWishListItemsResponse getCustomerWishList(Integer customerProfileOid) throws ApiException {
        ApiResponse<CustomerWishListItemsResponse> localVarResp = getCustomerWishListWithHttpInfo(customerProfileOid);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CustomerWishListItemsResponse> getCustomerWishListWithHttpInfo(Integer customerProfileOid) throws ApiException {
        okhttp3.Call localVarCall = getCustomerWishListValidateBeforeCall(customerProfileOid, null);
     ...
     */
    public okhttp3.Call getCustomerWishListAsync(Integer customerProfileOid, final ApiCallback<CustomerWishListItemsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomerWishListValidateBeforeCall(customerProfileOid, _callback);
        Type localVarReturnType = new TypeToken<CustomerWishListItemsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getCustomerWishListItemCall(Integer customerProfileOid, Integer customerWishlistItemOid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomerWishListItemValidateBeforeCall(Integer customerProfileOid, Integer customerWishlistItemOid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomerWishListItemCall(customerProfileOid, customerWishlistItemOid, _callback);
        return localVarCall;
    ...
    public CustomerWishListItemResponse getCustomerWishListItem(Integer customerProfileOid, Integer customerWishlistItemOid) throws ApiException {
        ApiResponse<CustomerWishListItemResponse> localVarResp = getCustomerWishListItemWithHttpInfo(customerProfileOid, customerWishlistItemOid);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CustomerWishListItemResponse> getCustomerWishListItemWithHttpInfo(Integer customerProfileOid, Integer customerWishlistItemOid) throws ApiException {
        okhttp3.Call localVarCall = getCustomerWishListItemValidateBeforeCall(customerProfileOid, customerWishlistItemOid, null);
     ...
     */
    public okhttp3.Call getCustomerWishListItemAsync(Integer customerProfileOid, Integer customerWishlistItemOid, final ApiCallback<CustomerWishListItemResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomerWishListItemValidateBeforeCall(customerProfileOid, customerWishlistItemOid, _callback);
        Type localVarReturnType = new TypeToken<CustomerWishListItemResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for getQuickBooksOnlineCustomers
     * @param q Search query matched against the QuickBooks Online customer display name (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getQuickBooksOnlineCustomersCall(String q, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/customer/quickbooks_online/customers";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getQuickBooksOnlineCustomersValidateBeforeCall(String q, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getQuickBooksOnlineCustomersCall(q, _callback);
        return localVarCall;
     ...
     */
    public QuickBooksOnlineCustomersResponse getQuickBooksOnlineCustomers(String q) throws ApiException {
        ApiResponse<QuickBooksOnlineCustomersResponse> localVarResp = getQuickBooksOnlineCustomersWithHttpInfo(q);
        return localVarResp.getData();
    }
     ...
     * Typeahead search of the merchant&#39;s QuickBooks Online customers by display name.  Used by the customer profile editor to link a profile 1:1 to a QuickBooks Online customer.  Returns up to 100 matches.  If QuickBooks Online is not connected the list will be empty. 
     * @param q Search query matched against the QuickBooks Online customer display name (optional)
     * @return ApiResponse&lt;QuickBooksOnlineCustomersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<QuickBooksOnlineCustomersResponse> getQuickBooksOnlineCustomersWithHttpInfo(String q) throws ApiException {
        okhttp3.Call localVarCall = getQuickBooksOnlineCustomersValidateBeforeCall(q, null);
        Type localVarReturnType = new TypeToken<QuickBooksOnlineCustomersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search the merchant&#39;s QuickBooks Online customers (asynchronously)
     * Typeahead search of the merchant&#39;s QuickBooks Online customers by display name.  Used by the customer profile editor to link a profile 1:1 to a QuickBooks Online customer.  Returns up to 100 matches.  If QuickBooks Online is not connected the list will be empty. 
     * @param q Search query matched against the QuickBooks Online customer display name (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getQuickBooksOnlineCustomersAsync(String q, final ApiCallback<QuickBooksOnlineCustomersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getQuickBooksOnlineCustomersValidateBeforeCall(q, _callback);
        Type localVarReturnType = new TypeToken<QuickBooksOnlineCustomersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call insertWishListItemCall(Integer customerProfileOid, CustomerWishListItem wishlistItem, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call insertWishListItemValidateBeforeCall(Integer customerProfileOid, CustomerWishListItem wishlistItem, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = insertWishListItemCall(customerProfileOid, wishlistItem, _callback);
        return localVarCall;
     ...
     */
    public CustomerWishListItem insertWishListItem(Integer customerProfileOid, CustomerWishListItem wishlistItem) throws ApiException {
        ApiResponse<CustomerWishListItem> localVarResp = insertWishListItemWithHttpInfo(customerProfileOid, wishlistItem);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomerWishListItem> insertWishListItemWithHttpInfo(Integer customerProfileOid, CustomerWishListItem wishlistItem) throws ApiException {
        okhttp3.Call localVarCall = insertWishListItemValidateBeforeCall(customerProfileOid, wishlistItem, null);
     ...
     */
    public okhttp3.Call insertWishListItemAsync(Integer customerProfileOid, CustomerWishListItem wishlistItem, final ApiCallback<CustomerWishListItem> _callback) throws ApiException {

        okhttp3.Call localVarCall = insertWishListItemValidateBeforeCall(customerProfileOid, wishlistItem, _callback);
        Type localVarReturnType = new TypeToken<CustomerWishListItem>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call searchCustomersCall(String searchString, String signupDtsStart, String signupDtsEnd, Integer limit, Integer offset, String since, String sort, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchCustomersValidateBeforeCall(String searchString, String signupDtsStart, String signupDtsEnd, Integer limit, Integer offset, String since, String sort, String expand, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchCustomersCall(searchString, signupDtsStart, signupDtsEnd, limit, offset, since, sort, expand, _callback);
        return localVarCall;
    ...
    public CustomersResponse searchCustomers(String searchString, String signupDtsStart, String signupDtsEnd, Integer limit, Integer offset, String since, String sort, String expand) throws ApiException {
        ApiResponse<CustomersResponse> localVarResp = searchCustomersWithHttpInfo(searchString, signupDtsStart, signupDtsEnd, limit, offset, since, sort, expand);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CustomersResponse> searchCustomersWithHttpInfo(String searchString, String signupDtsStart, String signupDtsEnd, Integer limit, Integer offset, String since, String sort, String expand) throws ApiException {
        okhttp3.Call localVarCall = searchCustomersValidateBeforeCall(searchString, signupDtsStart, signupDtsEnd, limit, offset, since, sort, expand, null);
        Type localVarReturnType = new TypeToken<CustomersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchCustomersAsync(String searchString, String signupDtsStart, String signupDtsEnd, Integer limit, Integer offset, String since, String sort, String expand, final ApiCallback<CustomersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchCustomersValidateBeforeCall(searchString, signupDtsStart, signupDtsEnd, limit, offset, since, sort, expand, _callback);
        Type localVarReturnType = new TypeToken<CustomersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for updateCustomerEmailSuppression
     * @param customerProfileOid The customer profile oid (required)
     * @param suppressionChanges Suppression changes (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateCustomerEmailSuppressionCall(Integer customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = suppressionChanges;

        // create path and map variables
        String localVarPath = "/customer/customers/{customer_profile_oid}/email_suppression"
            .replaceAll("\\{" + "customer_profile_oid" + "\\}", localVarApiClient.escapeString(customerProfileOid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateCustomerEmailSuppressionValidateBeforeCall(Integer customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'customerProfileOid' is set
        if (customerProfileOid == null) {
            throw new ApiException("Missing the required parameter 'customerProfileOid' when calling updateCustomerEmailSuppression(Async)");
        }
        
        // verify the required parameter 'suppressionChanges' is set
        if (suppressionChanges == null) {
            throw new ApiException("Missing the required parameter 'suppressionChanges' when calling updateCustomerEmailSuppression(Async)");
        }
        

        okhttp3.Call localVarCall = updateCustomerEmailSuppressionCall(customerProfileOid, suppressionChanges, _callback);
        return localVarCall;
     ...
     */
    public CustomerEmailSuppressionResponse updateCustomerEmailSuppression(Integer customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges) throws ApiException {
        ApiResponse<CustomerEmailSuppressionResponse> localVarResp = updateCustomerEmailSuppressionWithHttpInfo(customerProfileOid, suppressionChanges);
        return localVarResp.getData();
    }
     ...
     * @param customerProfileOid The customer profile oid (required)
     * @param suppressionChanges Suppression changes (required)
     * @return ApiResponse&lt;CustomerEmailSuppressionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomerEmailSuppressionResponse> updateCustomerEmailSuppressionWithHttpInfo(Integer customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges) throws ApiException {
        okhttp3.Call localVarCall = updateCustomerEmailSuppressionValidateBeforeCall(customerProfileOid, suppressionChanges, null);
        Type localVarReturnType = new TypeToken<CustomerEmailSuppressionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Clear email suppression for a customer (asynchronously)
     * Clears global unsubscribe, spam complaint and/or bounce suppression for a customer.  This method is clear-only and cannot set a suppression flag.  Clearing a suppression removes the send gate but does not subscribe the customer to any email list -- list membership survives a global unsubscribe untouched, so the customer&#39;s original lists become deliverable again with no further action.  Returns 200 with a warning if the flags were cleared but an upstream ESP suppression removal failed; the profile was still modified in that case. 
     * @param customerProfileOid The customer profile oid (required)
     * @param suppressionChanges Suppression changes (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateCustomerEmailSuppressionAsync(Integer customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, final ApiCallback<CustomerEmailSuppressionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCustomerEmailSuppressionValidateBeforeCall(customerProfileOid, suppressionChanges, _callback);
        Type localVarReturnType = new TypeToken<CustomerEmailSuppressionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateWishListItemCall(Integer customerProfileOid, Integer customerWishlistItemOid, CustomerWishListItem wishlistItem, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateWishListItemValidateBeforeCall(Integer customerProfileOid, Integer customerWishlistItemOid, CustomerWishListItem wishlistItem, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateWishListItemCall(customerProfileOid, customerWishlistItemOid, wishlistItem, _callback);
        return localVarCall;
     ...
     */
    public CustomerWishListItem updateWishListItem(Integer customerProfileOid, Integer customerWishlistItemOid, CustomerWishListItem wishlistItem) throws ApiException {
        ApiResponse<CustomerWishListItem> localVarResp = updateWishListItemWithHttpInfo(customerProfileOid, customerWishlistItemOid, wishlistItem);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomerWishListItem> updateWishListItemWithHttpInfo(Integer customerProfileOid, Integer customerWishlistItemOid, CustomerWishListItem wishlistItem) throws ApiException {
        okhttp3.Call localVarCall = updateWishListItemValidateBeforeCall(customerProfileOid, customerWishlistItemOid, wishlistItem, null);
        Type localVarReturnType = new TypeToken<CustomerWishListItem>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateWishListItemAsync(Integer customerProfileOid, Integer customerWishlistItemOid, CustomerWishListItem wishlistItem, final ApiCallback<CustomerWishListItem> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateWishListItemValidateBeforeCall(customerProfileOid, customerWishlistItemOid, wishlistItem, _callback);
        Type localVarReturnType = new TypeToken<CustomerWishListItem>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
