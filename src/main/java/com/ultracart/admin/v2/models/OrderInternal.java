...
public class OrderInternal   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the order has been exported to QuickBooks. If QuickBooks is not configured, then this will already be true")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Merchant notes")
   ...
   * @return placedByUser
  **/
  @ApiModelProperty(example = "null", value = "If placed via the BEOE, this is the user that placed the order")
   ...
   * @return refundByUser
  **/
  @ApiModelProperty(example = "null", value = "User that issued the refund")
   ...
   * @return salesRepCode
  **/
  @ApiModelProperty(example = "null", value = "Sales rep code associated with the order")
