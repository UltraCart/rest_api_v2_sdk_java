...
public class OrderBuysafe   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if a buySAFE bond was available for purchase on this order")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the buySAFE bond was free for this order")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the buySAFE bond was wanted by the customer")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Shopping cart ID associated with the buySAFE bond")
