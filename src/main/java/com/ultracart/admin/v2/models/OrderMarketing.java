...
public class OrderMarketing   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Advertising source")
   ...
   * @return mailingList
  **/
  @ApiModelProperty(example = "null", value = "True if the customer has opted into mailing list subscription")
   ...
   * @return referralCode
  **/
  @ApiModelProperty(example = "null", value = "Referral code")
