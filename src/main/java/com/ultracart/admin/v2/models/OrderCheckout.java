...
public class OrderCheckout   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "IP address of the customer when placing the order")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Upsell path code assigned during the checkout that the customer went through")
