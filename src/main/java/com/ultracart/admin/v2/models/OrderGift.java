...
public class OrderGift   {
   ...
   * @return gift
  **/
  @ApiModelProperty(example = "null", value = "True if the order is a gift")
  ...
  **/
  @ApiModelProperty(example = "null", value = "QuickBooks code for the gift charge")
  ...
  **/
  @ApiModelProperty(example = "null", value = "QuickBooks code for the gift wrap charge")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Title of the gift wrap that the customer wants used")
