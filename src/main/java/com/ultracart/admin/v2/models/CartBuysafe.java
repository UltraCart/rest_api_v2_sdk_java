...
public class CartBuysafe   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if buySAFE is willing to bond the order")
  ...
  **/
   ...
   * @return bondFree
  **/
  @ApiModelProperty(example = "null", value = "True if the bond is free (merchant paying for it)")
   ...
   * @return bondWanted
  **/
  @ApiModelProperty(example = "null", value = "True if the customer wants the bond")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Recommend text to display to the customer")
  ...
  **/
  @ApiModelProperty(example = "null", value = "URL associated with the recommended text")
