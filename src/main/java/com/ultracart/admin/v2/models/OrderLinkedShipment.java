...
public class OrderLinkedShipment   {
  ...
  private List<String> linkedShipmentChannelPartnerOrderIds = new ArrayList<String>();

  @SerializedName("linked_shipment_order_ids")
  private List<String> linkedShipmentOrderIds = new ArrayList<String>();
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if this order has child linked shipments")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if this order is linked to another parent order")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The child linked shipment channel partner order ids")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The child linked shipment order ids")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The parent order id that this one is linked to")
