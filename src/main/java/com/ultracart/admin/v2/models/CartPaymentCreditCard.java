...
public class CartPaymentCreditCard   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Card verification number (masked)")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Hosted field token for the card verification number")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the customer wants to store the card on their profile for future re-use")
