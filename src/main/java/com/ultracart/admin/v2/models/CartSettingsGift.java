...
public class CartSettingsGift   {
  ...
  private List<CartSettingsGiftWrap> giftWraps = new ArrayList<CartSettingsGiftWrap>();
   ...
   * @return allowGifts
  **/
  @ApiModelProperty(example = "null", value = "True if this checkout supports gift giving")
  ...
  **/
   ...
   * @return giftWraps
  **/
  @ApiModelProperty(example = "null", value = "The gift wraps available for the customer to select from")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum length of the gift message the giver can enter")
