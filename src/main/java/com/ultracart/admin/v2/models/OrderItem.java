...
public class OrderItem   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "QuickBooks code")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Activation codes assigned to this item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Channel partner item id if this order came through a channel partner and the channel partner item id was mapped to an internal item id")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Value of the kit component item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Country of origin (ISO-3166 two letter code)")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Discount quantity")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Distribution center code responsible for shipping this item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if this item is excluded from coupons")
   ...
   * @return freeShipping
  **/
  @ApiModelProperty(example = "null", value = "True if the item receives free shipping")
   ...
   * @return hazmat
  **/
  @ApiModelProperty(example = "null", value = "Hazardous materials indicator")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Item reference object identifier used to linked to auto order item record")
  ...
  **/
   ...
   * @return kitComponent
  **/
  @ApiModelProperty(example = "null", value = "True if this item is a kit component")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Maximum days that the item can be in transit before spoilage (perishable products)")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Mix and match group name")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if this item is excluded from shipping discounts")
  ...
  **/
   ...
   * @return packedByUser
  **/
  @ApiModelProperty(example = "null", value = "Packed by user")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Perishable class of the item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Pricing tier that granted the particular price for this item if the customer profile had pricing tiers assigned")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Quantity refunded on this item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "QuickBooks class")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if this item ships in a separate box")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Shipped by user")
   ...
   * @return shippedDts
  **/
  @ApiModelProperty(example = "null", value = "Date/time that this item was marked shipped")
  ...
  **/
   ...
   * @return taxFree
  **/
  @ApiModelProperty(example = "null", value = "True if the item is tax free")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Date/time that this item was transmitted to the distribution center")
  ...
  **/
   ...
   * @return upsell
  **/
  @ApiModelProperty(example = "null", value = "True if this item was added to the order as part of an upsell")
