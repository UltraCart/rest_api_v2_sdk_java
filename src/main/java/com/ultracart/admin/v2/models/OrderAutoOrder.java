...
public class OrderAutoOrder {
  ...
  **/
  @ApiModelProperty(value = "Unique code assigned to the auto order")
   ...
   * @return autoOrderOid
  **/
  @ApiModelProperty(value = "Unique identifier assigned to the auto order")
  ...
  **/
  @ApiModelProperty(value = "Orignal order id that started this auto order sequence")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoOrderCode, autoOrderOid, originalOrderId, status);
  }
