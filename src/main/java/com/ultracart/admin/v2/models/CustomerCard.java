...
public class CustomerCard   {
  ...
  **/
   ...
   * @return cardNumber
  **/
  @ApiModelProperty(example = "null", value = "Card number (masked to the last 4)")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Hosted field token for the card number")
  ...
  **/
  @ApiModelProperty(example = "null", value = "ID of the stored credit card to use")
