...
public class OrderDigitalItem   {
  ...
  **/
   ...
   * @return lastDownload
  **/
  @ApiModelProperty(example = "null", value = "Last download")
  ...
  **/
  @ApiModelProperty(example = "null", value = "IP address that performed the last download")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Original file name")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "null", value = "Item id associated with this item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Item description associated with this item")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Remaining number of downloads")
   ...
   * @return url
  **/
  @ApiModelProperty(example = "null", value = "URL that the customer can click to download the specific digital item")
