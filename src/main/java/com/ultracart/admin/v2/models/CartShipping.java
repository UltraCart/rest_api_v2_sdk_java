...
public class CartShipping   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the shipping adress is residential.  Effects the methods that are available to the customer as well as the price of the shipping method.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "3rd party account number to ship against for UPS or FedEx")
  ...
  **/
   ...
   * @return stateRegion
  **/
  @ApiModelProperty(example = "null", value = "State/Region")
