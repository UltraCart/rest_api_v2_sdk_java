...
public class IntegrationLogApi {
  ...
  public IntegrationLogApi(String apiKey, boolean verifySsl, boolean debugging){
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getIntegrationLogFilePdfCall(String pk, String sk, String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getIntegrationLogFilePdfValidateBeforeCall(String pk, String sk, String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getIntegrationLogFilePdfCall(pk, sk, uuid, progressListener, progressRequestListener);
        return call;
    ...
    public File getIntegrationLogFilePdf(String pk, String sk, String uuid) throws ApiException {
        ApiResponse<File> resp = getIntegrationLogFilePdfWithHttpInfo(pk, sk, uuid);
        return resp.getData();
    }
    ...
    public ApiResponse<File> getIntegrationLogFilePdfWithHttpInfo(String pk, String sk, String uuid) throws ApiException {
        com.squareup.okhttp.Call call = getIntegrationLogFilePdfValidateBeforeCall(pk, sk, uuid, null, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getIntegrationLogFilePdfAsync(String pk, String sk, String uuid, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getIntegrationLogFilePdfValidateBeforeCall(pk, sk, uuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
